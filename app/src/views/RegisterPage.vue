...
const onSubmit = handleSubmit(async (values) => {
  try {
    await authStore.register(values.fullName, values.email, values.password);
...
<template>
  <div class="flex items-center justify-center min-h-screen bg-blue-100">
    <div class="w-full max-w-md p-8 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transform -rotate-1">
      <h2 class="text-3xl font-bold mb-6 transform rotate-2 bg-yellow-300 inline-block px-4 py-2 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">Register</h2>
